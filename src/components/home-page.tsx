...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* Weather Section */}
      <section id="weather" className="py-20 bg-gradient-to-br from-alpine to-charcoal">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-playfair text-4xl font-bold text-white mb-4">Current Conditions</h2>
            <p className="text-xl text-white/80">Live weather updates from Gudauri ski resort</p>
          </div>
      ...
      {/* Booking Section */}
      <section id="booking" className="py-20 bg-gradient-to-br from-charcoal to-alpine">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-playfair text-4xl font-bold text-white mb-4">Reserve Your Alpine Escape</h2>
            <p className="text-xl text-white/80 mb-8">Experience luxury like never before in the Georgian mountains</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8">
                <h3 className="font-playfair text-2xl font-bold text-white mb-4">Direct Booking</h3>
                <p className="text-white/80 mb-6">Contact us directly for personalized service and exclusive rates</p>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center text-white">
                    ...
                    <span>info@alpineluxury.ge</span>
                  </div>
                  <div className="flex items-center text-white">
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8">
                <h3 className="font-playfair text-2xl font-bold text-white mb-4">Book on Airbnb</h3>
                <p className="text-white/80 mb-6">Secure booking with instant confirmation through Airbnb</p>
                <Button 
                  size="lg"
                  className="w-full bg-white text-charcoal hover:bg-white/90 font-semibold py-3 rounded-xl transition-all duration-300"
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8">
            <h3 className="font-playfair text-2xl font-bold text-white mb-6 text-center">Send Us an Inquiry</h3>
            <ContactForm />
          </div>
        </div>
      </section>
      ...
      <footer className="bg-charcoal text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="font-playfair text-2xl font-bold mb-4">Alpine Luxury</h3>
              <p className="text-white/80 mb-4">Experience the pinnacle of luxury in the heart of Georgia&apos;s premier ski destination.</p>
              <div className="flex space-x-4">
                <Facebook className="h-6 w-6 text-white/60 hover:text-gold cursor-pointer transition-colors" />
                <Instagram className="h-6 w-6 text-white/60 hover:text-gold cursor-pointer transition-colors" />
                <Twitter className="h-6 w-6 text-white/60 hover:text-gold cursor-pointer transition-colors" />
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><button onClick={() => scrollToSection("property")} className="text-white/80 hover:text-gold transition-colors">Property</button></li>
                <li><button onClick={() => scrollToSection("amenities")} className="text-white/80 hover:text-gold transition-colors">Amenities</button></li>
                <li><button onClick={() => scrollToSection("weather")} className="text-white/80 hover:text-gold transition-colors">Weather</button></li>
                <li><button onClick={() => scrollToSection("faq")} className="text-white/80 hover:text-gold transition-colors">FAQ</button></li>
              </ul>
            </div>
          ...
          <div className="border-t border-white/20 mt-8 pt-8 text-center">
            <p className="text-white/60">&copy; 2024 Alpine Luxury. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
